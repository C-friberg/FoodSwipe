        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BayesianScore = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecipeInteractions_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeInteractions_RecipeId",
                table: "RecipeInteractions",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeInteractions_UserId_RecipeId_ActionType",
                table: "RecipeInteractions",
                columns: new[] { "UserId", "RecipeId", "ActionType" },
                unique: true);
        }
